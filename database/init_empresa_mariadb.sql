...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    -- Configuración de Correo (SMTP)
      ...
      puerto_email INT DEFAULT NULL,

      -- Permisos de Nivel Superior
      super_user TINYINT(1) DEFAULT 0, -- 1 para admin, 0 para usuario estándar
...
CREATE TABLE IF NOT EXISTS alb_pro (
  ...
  envio_to_coste TINYINT(1) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS articulos_excepciones (
  ...
  id_familia_cliente INT DEFAULT NULL,
  id_subfamilia_cliente INT DEFAULT NULL,
  ...
  id_aviso_ini INT DEFAULT NULL,
  id_aviso_fin INT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS articulos_ofertas (
  id INT AUTO_INCREMENT PRIMARY KEY,
  id_articulo INT DEFAULT NULL,
  id_tarifa INT DEFAULT 0,
  descripcion VARCHAR(100) NOT NULL,

  -- Flags de tipo de oferta (Convertidos a SMALLINT para compatibilidad universal)
  oferta_32 TINYINT(1) DEFAULT 0,
  oferta_dto TINYINT(1) DEFAULT 0,
  oferta_precio_final TINYINT(1) DEFAULT 0,
  oferta_web TINYINT(1) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS cab_alb (
  ...
  id_pais_entrega INT DEFAULT NULL,
  ...
  id_forma_pago INT DEFAULT 0,
  id_transportista INT DEFAULT 0,
  id_agente INT DEFAULT 0,
  id_usuario INT DEFAULT 0,
  id_caja INT DEFAULT 0,
  ejercicio INT DEFAULT NULL,
  editable TINYINT(1) DEFAULT 1,
  es_simplificada TINYINT(1) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS cab_pre (
  ...
  id_divisa INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS gastos_ped_pro (
  id INT AUTO_INCREMENT PRIMARY KEY,
  id_cab INT DEFAULT 0, -- Referencia a la cabecera del pedido
...
CREATE TABLE IF NOT EXISTS lin_alb_pro (
  ...
  -- Cantidad: He cambiado INT a DECIMAL(12,3)
...
CREATE TABLE IF NOT EXISTS ped_pro (
  ...
  desc_gasto1 VARCHAR(45) DEFAULT NULL, imp_gasto1 DECIMAL(15,4) DEFAULT 0,
  porc_iva_gasto1 DECIMAL(5,2) DEFAULT 0, iva_gasto1 DECIMAL(15,4) DEFAULT 0,
  gasto_to_coste TINYINT(1) DEFAULT 0, -- Importante para el escandallo
  ...
  editable TINYINT(1) DEFAULT 1,
  id_forma_pago INT DEFAULT 0,
  pedido_cliente INT DEFAULT 0, -- Relación con el encargo del cliente
  comentario TEXT,
...
CREATE TABLE IF NOT EXISTS acum_articulos (
  ...
  ejercicio INT NOT NULL, -- He añadido este campo para separar años fácilmente
...
CREATE TABLE IF NOT EXISTS acum_clientes (
  ...
  id_empresa INT NOT NULL DEFAULT 0,
  id_cliente INT NOT NULL DEFAULT 0,
  ejercicio INT NOT NULL, -- Fundamental para históricos anuales
...
CREATE TABLE IF NOT EXISTS acum_proveedores (
  ...
  id_empresa INT NOT NULL DEFAULT 0,
  id_proveedor INT DEFAULT 0,
  ejercicio INT NOT NULL, -- Para separar los gastos por año
...
CREATE TABLE IF NOT EXISTS agenda (
  ...
  is_medica TINYINT(1) DEFAULT 0,  -- Lo mantengo por compatibilidad, aunque quizás en tu sector sea "is_presencial"
  is_cita TINYINT(1) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS articulos (
  ...
  id_subfamilia INT DEFAULT NULL,
  kit TINYINT(1) DEFAULT 0, -- Para "Packs" de servicios
  ...
  id_web INT DEFAULT 0,
  articulo_promocionado TINYINT(1) DEFAULT 0,
  mostrar_en_cuadro TINYINT(1) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS avisos (
  ...
  completado TINYINT(1) DEFAULT 0, -- 0: Pendiente, 1: Leído/Cerrado
...
CREATE TABLE IF NOT EXISTS cliente_direcciones (
  ...
  direccion_envio TINYINT(1) DEFAULT 0, -- 1 si es la dirección por defecto para envíos
...
CREATE TABLE IF NOT EXISTS clientes (
  ...
  id_divisa INT NOT NULL DEFAULT 1,
  id_empresa INT DEFAULT NULL,
  id_idioma_documentos INT DEFAULT 1, -- Clave para facturas en FR o ES
  ...
  dia_pago1 INT DEFAULT 0,
  dia_pago2 INT DEFAULT 0,
  porc_dto_cliente DECIMAL(5,2) DEFAULT 0,
  recargo_equivalencia TINYINT(1) DEFAULT 0, -- (España)
  irpf TINYINT(1) DEFAULT 0,                 -- (España)
  grupo_iva INT DEFAULT 1,             -- (TVA Francia / IVA España)
...
CREATE TABLE IF NOT EXISTS clientes_deuda (
  ...
  tipo INT DEFAULT 0, -- Ej: 1-Factura, 2-Recibo, 3-Nota de cargo
...
CREATE TABLE IF NOT EXISTS clientes_entregas (
  ...
  id_concepto_ref INT DEFAULT 0,  -- Para mantener la referencia numérica si es necesario
...
CREATE TABLE IF NOT EXISTS deudas_proveedores (
  ...
  id_documento INT DEFAULT NULL, -- Referencia a la tabla facturas_proveedores
  ...
  asiento_numero INT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS familias (
  ...
  -- Jerarquía
  id_seccion INT DEFAULT 0,      -- Vinculación con un nivel superior (Secciones)
...
CREATE TABLE IF NOT EXISTS formpago (
  ...
  numero_plazos INT DEFAULT 1,
  dias_hasta_pago INT DEFAULT 0,    -- Días de carencia antes del primer pago
  dias_entre_plazos INT DEFAULT 0,  -- Frecuencia entre cuotas

  -- Días Fijos de Pago (común en grandes empresas)
  dia_pago1 INT DEFAULT 0,
  dia_pago2 INT DEFAULT 0,
  dia_pago3 INT DEFAULT 0,
  dia_pago4 INT DEFAULT 0,

  -- Contabilidad y Tipo
  cuenta_cont_pago VARCHAR(20) DEFAULT NULL,
  al_contado TINYINT(1) DEFAULT 0, -- 1 si el pago es inmediato (efectivo/tarjeta)
...
CREATE TABLE IF NOT EXISTS paises (
  ...
  id_monedas INT DEFAULT NULL,       -- Relación con la tabla 'monedas'
...
CREATE TABLE IF NOT EXISTS permisos_agenda (
  ...
  id_usuario_editor INT DEFAULT NULL,

  -- El dueño de la agenda a la que se accede
  id_usuario_agenda INT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS proveedores (
  ...
  id_pais_almacen INT DEFAULT NULL,

  -- Configuración Comercial y Pago
  id_forma_pago INT DEFAULT NULL,
  dia_cobro INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS tarifas (
  id INT AUTO_INCREMENT PRIMARY KEY,
  id_articulo INT DEFAULT NULL,
  id_codigo_tarifa INT DEFAULT NULL, -- Relación con 'codigotarifa' (ej: Tarifa Web, Tarifa Amigo)
...
CREATE TABLE IF NOT EXISTS tiposubcliente (
  id INT AUTO_INCREMENT PRIMARY KEY,
  id_tipocliente INT DEFAULT NULL, -- Relación con el tipo padre
...
CREATE TABLE IF NOT EXISTS transportista (
  ...
  id_proveedor INT NOT NULL DEFAULT 0, -- Referencia a la tabla 'proveedores'
  fecha_alta DATE DEFAULT NULL,
