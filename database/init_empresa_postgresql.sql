...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    -- Configuración de Correo (SMTP)
      ...
      super_user SMALLINT DEFAULT 0, -- 1 para admin, 0 para usuario estándar
...
CREATE TABLE IF NOT EXISTS alb_pro (
  ...
  -- Bases e Impuestos (Usamos NUMERIC para precisión contable)
  total1 NUMERIC(15,4) DEFAULT 0,
  total2 NUMERIC(15,4) DEFAULT 0,
  total3 NUMERIC(15,4) DEFAULT 0,
  total4 NUMERIC(15,4) DEFAULT 0,
  porc_iva1 NUMERIC(5,2) DEFAULT 0,
  porc_iva2 NUMERIC(5,2) DEFAULT 0,
  porc_iva3 NUMERIC(5,2) DEFAULT 0,
  porc_iva4 NUMERIC(5,2) DEFAULT 0,
  iva1 NUMERIC(15,4) DEFAULT 0,
  iva2 NUMERIC(15,4) DEFAULT 0,
  iva3 NUMERIC(15,4) DEFAULT 0,
  iva4 NUMERIC(15,4) DEFAULT 0,
  base1 NUMERIC(15,4) DEFAULT 0,
  base2 NUMERIC(15,4) DEFAULT 0,
  base3 NUMERIC(15,4) DEFAULT 0,
  base4 NUMERIC(15,4) DEFAULT 0,

  factura VARCHAR(30) DEFAULT NULL,
  base_total NUMERIC(15,4) DEFAULT 0,
  iva_total NUMERIC(15,4) DEFAULT 0,
  ...
  porc_rec1 NUMERIC(5,2) DEFAULT 0,
  porc_rec2 NUMERIC(5,2) DEFAULT 0,
  porc_rec3 NUMERIC(5,2) DEFAULT 0,
  porc_rec4 NUMERIC(5,2) DEFAULT 0,
  rec1 NUMERIC(15,4) DEFAULT 0,
  rec2 NUMERIC(15,4) DEFAULT 0,
  rec3 NUMERIC(15,4) DEFAULT 0,
  rec4 NUMERIC(15,4) DEFAULT 0,
  total_recargo NUMERIC(15,4) DEFAULT 0,
  ...
  porc_dto NUMERIC(5,2) DEFAULT 0,
  dto NUMERIC(15,4) DEFAULT 0,
  ...
  imp_envio1 NUMERIC(15,4) DEFAULT 0,
  imp_envio2 NUMERIC(15,4) DEFAULT 0,
  imp_envio3 NUMERIC(15,4) DEFAULT 0,
  porc_iva_envio1 NUMERIC(5,2) DEFAULT 0,
  porc_iva_envio2 NUMERIC(5,2) DEFAULT 0,
  porc_iva_envio3 NUMERIC(5,2) DEFAULT 0,
  iva_envio1 NUMERIC(15,4) DEFAULT 0,
  iva_envio2 NUMERIC(15,4) DEFAULT 0,
  iva_envio3 NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS articulos_excepciones (
  ...
  -- Cálculos y Precios (Cambiado double por NUMERIC para precisión)
  importe_porc_aumento NUMERIC(15,4) DEFAULT 0,
  importe_moneda_aumento NUMERIC(15,4) DEFAULT 0,
  importe_fijo NUMERIC(15,4) DEFAULT 0,
  dto_aumento_fijo NUMERIC(15,4) DEFAULT 0,
  dto_aumento_porc NUMERIC(15,4) DEFAULT 0,
  dto_fijo NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS articulos_ofertas (
  ...
  -- Cantidades y Descuentos (NUMERIC para evitar errores de redondeo en cálculos)
  unidades NUMERIC(12,3) DEFAULT 0,
  regalo NUMERIC(12,3) DEFAULT 0,
  dto_local NUMERIC(5,2) DEFAULT 0,
  dto_web NUMERIC(5,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS cab_alb (
  ...
  -- Totales y Descuentos (NUMERIC para precisión)
  subtotal NUMERIC(15,4) DEFAULT 0,
  porc_dto NUMERIC(5,2) DEFAULT 0,
  dto NUMERIC(15,4) DEFAULT 0,
  porc_dto_pp NUMERIC(5,2) DEFAULT 0,
  dto_pp NUMERIC(15,4) DEFAULT 0,
  ...
  porc_irpf NUMERIC(5,2) DEFAULT 0,
  irpf NUMERIC(15,4) DEFAULT 0,
  ...
  base_total NUMERIC(15,4) DEFAULT 0,
  iva_total NUMERIC(15,4) DEFAULT 0,
  rec_total NUMERIC(15,4) DEFAULT 0,
  total_albaran NUMERIC(15,4) DEFAULT 0,
  entregado_a_cuenta NUMERIC(15,4) DEFAULT 0,
  ...
  imp_gastos_envio1 NUMERIC(15,4) DEFAULT 0,
  imp_gastos_envio2 NUMERIC(15,4) DEFAULT 0,
  imp_gastos_envio3 NUMERIC(15,4) DEFAULT 0,
  porc_iva_gastos_envio1 NUMERIC(5,2) DEFAULT 0,
  porc_iva_gastos_envio2 NUMERIC(5,2) DEFAULT 0,
  porc_iva_gastos_envio3 NUMERIC(5,2) DEFAULT 0,
  iva_gastos_envio1 NUMERIC(15,4) DEFAULT 0,
  iva_gastos_envio2 NUMERIC(15,4) DEFAULT 0,
  iva_gastos_envio3 NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS cab_fac (
  ...
  -- Totales (Cambiado double por NUMERIC para precisión contable)
  subtotal NUMERIC(15,4) DEFAULT 0,
  porc_dto NUMERIC(5,2) DEFAULT 0,
  dto NUMERIC(15,4) DEFAULT 0,
  porc_dto_pp NUMERIC(5,2) DEFAULT 0,
  ...
  entregado_a_cuenta NUMERIC(15,4) DEFAULT 0,
  importe_pendiente NUMERIC(15,4) DEFAULT 0,
  id_forma_pago INTEGER DEFAULT 0,
  ...
  efectivo NUMERIC(15,4) DEFAULT 0,
  transferencia NUMERIC(15,4) DEFAULT 0,
  tarjeta NUMERIC(15,4) DEFAULT 0,
  cheque NUMERIC(15,4) DEFAULT 0,
  internet NUMERIC(15,4) DEFAULT 0,
  pagado NUMERIC(15,4) DEFAULT 0,
  pendiente NUMERIC(15,4) DEFAULT 0,

  -- Otros Gastos
  desc_gasto1 VARCHAR(45) DEFAULT NULL,
  desc_gasto2 VARCHAR(45) DEFAULT NULL,
  desc_gasto3 VARCHAR(45) DEFAULT NULL,
  imp_gasto1 NUMERIC(15,4) DEFAULT 0,
  imp_gasto2 NUMERIC(15,4) DEFAULT 0,
  imp_gasto3 NUMERIC(15,4) DEFAULT 0,
  porc_iva_gasto1 NUMERIC(5,2) DEFAULT 0,
  porc_iva_gasto2 NUMERIC(5,2) DEFAULT 0,
  porc_iva_gasto3 NUMERIC(5,2) DEFAULT 0,
  iva_gasto1 NUMERIC(15,4) DEFAULT 0,
  iva_gasto2 NUMERIC(15,4) DEFAULT 0,
  iva_gasto3 NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS cab_pre (
  ...
  valor_divisa NUMERIC(12,6) DEFAULT 1.0, -- Mayor precisión para tipos de cambio
  fecha DATE DEFAULT NULL,
  ...
  subtotal NUMERIC(15,4) DEFAULT 0, -- Se suele usar 'base' o 'subtotal'
  base_total NUMERIC(15,4) DEFAULT 0,
  porc_dto NUMERIC(5,2) DEFAULT 0,
  dto NUMERIC(15,4) DEFAULT 0,
  porc_dto_pp NUMERIC(5,2) DEFAULT 0,
  dto_pp NUMERIC(15,4) DEFAULT 0,
  total_iva NUMERIC(15,4) DEFAULT 0,
  total_recargo NUMERIC(15,4) DEFAULT 0,
  total_presupuesto NUMERIC(15,4) DEFAULT 0, -- Equivalente a tu 'total'
  ...
  importe_gasto1 NUMERIC(15,4) DEFAULT 0,
  importe_gasto2 NUMERIC(15,4) DEFAULT 0,
  importe_gasto3 NUMERIC(15,4) DEFAULT 0,
  porc_iva_gasto1 NUMERIC(5,2) DEFAULT 0,
  porc_iva_gasto2 NUMERIC(5,2) DEFAULT 0,
  porc_iva_gasto3 NUMERIC(5,2) DEFAULT 0,
  iva_gasto1 NUMERIC(15,4) DEFAULT 0,
  ...
  importe_factura NUMERIC(15,4) DEFAULT 0,
  importe_pendiente NUMERIC(15,4) DEFAULT 0,
  id_forma_pago INTEGER DEFAULT 0,
  id_agente INTEGER DEFAULT 0,
  ejercicio INTEGER DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS gastos_ped_pro (
  ...
  importe NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS lin_alb (
  ...
  precio NUMERIC(15,4) DEFAULT 0,
  precio_recom NUMERIC(15,4) DEFAULT 0,
  subtotal NUMERIC(15,4) DEFAULT 0,
  ...
  porc_rec NUMERIC(5,2) DEFAULT 0,
  rec NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS lin_alb_pro (
  ...
  -- Cantidad: He cambiado INTEGER a NUMERIC(12,3)
  -- Aunque en tu SQL original era INT, para creativos es mejor NUMERIC
  ...
  precio NUMERIC(15,4) DEFAULT 0,
  subtotal NUMERIC(15,4) DEFAULT 0,
  coste_real_unidad NUMERIC(15,4) DEFAULT 0, -- Lo que realmente te costó tras gastos
...
CREATE TABLE IF NOT EXISTS lin_fac (
  ...
  -- Importes con precisión contable (NUMERIC)
  precio NUMERIC(15,4) DEFAULT 0,
  precio_recom NUMERIC(15,4) DEFAULT 0,
  subtotal NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS lin_fac_pro (
  ...
  -- Cantidad: Volvemos a NUMERIC por la flexibilidad de horas/servicios
  cantidad NUMERIC(12,3) DEFAULT 0,

  -- Importes con precisión contable
  precio NUMERIC(15,4) DEFAULT 0,
  subtotal NUMERIC(15,4) DEFAULT 0,
  coste_real_unidad NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS lin_ped (
  ...
  -- Cantidades: NUMERIC para soportar horas o entregas parciales
  cantidad NUMERIC(12,3) DEFAULT 0,
  cantidad_a_servir NUMERIC(12,3) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS lin_ped_pro (
  ...
  -- Cantidades: Pasamos de INT a NUMERIC para flexibilidad (horas, jornadas, GB)
  cantidad NUMERIC(12,3) DEFAULT 0,
  cantidad_recibida NUMERIC(12,3) DEFAULT 0,
  cantidad_pendiente NUMERIC(12,3) DEFAULT 0,
  en_albaran NUMERIC(12,3) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS lin_res (
  ...
  -- Cantidad: De INT a NUMERIC para reservar horas o jornadas
  cantidad NUMERIC(12,3) DEFAULT 0,

  -- Precios e Importes
  precio NUMERIC(15,4) DEFAULT 0,
  precio_recom NUMERIC(15,4) DEFAULT 0,
  importe_dto NUMERIC(15,4) DEFAULT 0,
  total NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS divisas (
  ...
  valor_divisa NUMERIC(12,6) DEFAULT 1.0,
...
CREATE TABLE IF NOT EXISTS ped_cli (
  ...
  -- Totales y Descuentos (Precisión NUMERIC)
  subtotal NUMERIC(15,4) DEFAULT 0,
  porc_dto NUMERIC(5,2) DEFAULT 0,
  dto NUMERIC(15,4) DEFAULT 0,
  porc_dto_pp NUMERIC(5,2) DEFAULT 0, -- Pronto Pago
  dto_pp NUMERIC(15,4) DEFAULT 0,
  base_total NUMERIC(15,4) DEFAULT 0,
  iva_total NUMERIC(15,4) DEFAULT 0,
  rec_total NUMERIC(15,4) DEFAULT 0,
  ...
  porc_irpf NUMERIC(5,2) DEFAULT 0,
  entregado_a_cuenta NUMERIC(15,4) DEFAULT 0,
  total_pedido NUMERIC(15,4) DEFAULT 0,

  -- Desglose de Impuestos (4 tramos)
  base1 NUMERIC(15,4) DEFAULT 0, base2 NUMERIC(15,4) DEFAULT 0,
  base3 NUMERIC(15,4) DEFAULT 0, base4 NUMERIC(15,4) DEFAULT 0,
  porc_iva1 NUMERIC(5,2) DEFAULT 0, porc_iva2 NUMERIC(5,2) DEFAULT 0,
  porc_iva3 NUMERIC(5,2) DEFAULT 0, porc_iva4 NUMERIC(5,2) DEFAULT 0,
  iva1 NUMERIC(15,4) DEFAULT 0, iva2 NUMERIC(15,4) DEFAULT 0,
  iva3 NUMERIC(15,4) DEFAULT 0, iva4 NUMERIC(15,4) DEFAULT 0,

  -- Recargo de Equivalencia (Específico España)
  recargo_equivalencia SMALLINT DEFAULT 0,
  porc_rec1 NUMERIC(5,2) DEFAULT 0, porc_rec2 NUMERIC(5,2) DEFAULT 0,
  porc_rec3 NUMERIC(5,2) DEFAULT 0, porc_rec4 NUMERIC(5,2) DEFAULT 0,
  rec1 NUMERIC(15,4) DEFAULT 0, rec2 NUMERIC(15,4) DEFAULT 0,
  rec3 NUMERIC(15,4) DEFAULT 0, rec4 NUMERIC(15,4) DEFAULT 0,

  -- Totales por tramo
  total1 NUMERIC(15,4) DEFAULT 0, total2 NUMERIC(15,4) DEFAULT 0,
  total3 NUMERIC(15,4) DEFAULT 0, total4 NUMERIC(15,4) DEFAULT 0,

  -- Gastos Adicionales
  desc_gasto1 VARCHAR(45) DEFAULT NULL, imp_gasto1 NUMERIC(15,4) DEFAULT 0,
  porc_iva_gasto1 NUMERIC(5,2) DEFAULT 0, iva_gasto1 NUMERIC(15,4) DEFAULT 0,
  gasto_to_coste SMALLINT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS ped_pro (
  ...
  -- Totales y Financiero (NUMERIC para precisión)
  subtotal NUMERIC(15,4) DEFAULT 0,
  porc_dto NUMERIC(5,2) DEFAULT 0,
  dto NUMERIC(15,4) DEFAULT 0,
  base_total NUMERIC(15,4) DEFAULT 0,
  rec_total NUMERIC(15,4) DEFAULT 0, -- Recargo total
  total NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS reservas (
  ...
  importe NUMERIC(15,4) DEFAULT 0,   -- Total de la reserva
  entregado NUMERIC(15,4) DEFAULT 0, -- Lo que ya ha pagado como señal
  pendiente NUMERIC(15,4) DEFAULT 0, -- Lo que falta por pagar
...
CREATE TABLE IF NOT EXISTS acum_articulos (
  ...
  unid_comp_enero NUMERIC(12,3) DEFAULT 0, unid_comp_febrero NUMERIC(12,3) DEFAULT 0,
  unid_comp_marzo NUMERIC(12,3) DEFAULT 0, unid_comp_abril NUMERIC(12,3) DEFAULT 0,
  unid_comp_mayo NUMERIC(12,3) DEFAULT 0, unid_comp_junio NUMERIC(12,3) DEFAULT 0,
  unid_comp_julio NUMERIC(12,3) DEFAULT 0, unid_comp_agosto NUMERIC(12,3) DEFAULT 0,
  unid_comp_septiembre NUMERIC(12,3) DEFAULT 0, unid_comp_octubre NUMERIC(12,3) DEFAULT 0,
  unid_comp_noviembre NUMERIC(12,3) DEFAULT 0, unid_comp_diciembre NUMERIC(12,3) DEFAULT 0,
  unid_comp_ejercicio NUMERIC(15,3) DEFAULT 0,

  -- Acumulado Compras (Importe €/$)
  acum_comp_enero NUMERIC(15,4) DEFAULT 0, acum_comp_febrero NUMERIC(15,4) DEFAULT 0,
  acum_comp_marzo NUMERIC(15,4) DEFAULT 0, acum_comp_abril NUMERIC(15,4) DEFAULT 0,
  acum_comp_mayo NUMERIC(15,4) DEFAULT 0, acum_comp_junio NUMERIC(15,4) DEFAULT 0,
  acum_comp_julio NUMERIC(15,4) DEFAULT 0, acum_comp_agosto NUMERIC(15,4) DEFAULT 0,
  acum_comp_septiembre NUMERIC(15,4) DEFAULT 0, acum_comp_octubre NUMERIC(15,4) DEFAULT 0,
  acum_comp_noviembre NUMERIC(15,4) DEFAULT 0, acum_comp_diciembre NUMERIC(15,4) DEFAULT 0,
  acum_comp_ejercicio NUMERIC(18,4) DEFAULT 0,

  -- Unidades Vendidas (Horas de diseño, proyectos, etc.)
  unid_vent_enero NUMERIC(12,3) DEFAULT 0, unid_vent_febrero NUMERIC(12,3) DEFAULT 0,
  unid_vent_marzo NUMERIC(12,3) DEFAULT 0, unid_vent_abril NUMERIC(12,3) DEFAULT 0,
  unid_vent_mayo NUMERIC(12,3) DEFAULT 0, unid_vent_junio NUMERIC(12,3) DEFAULT 0,
  unid_vent_julio NUMERIC(12,3) DEFAULT 0, unid_vent_agosto NUMERIC(12,3) DEFAULT 0,
  unid_vent_septiembre NUMERIC(12,3) DEFAULT 0, unid_vent_octubre NUMERIC(12,3) DEFAULT 0,
  unid_vent_noviembre NUMERIC(12,3) DEFAULT 0, unid_vent_diciembre NUMERIC(12,3) DEFAULT 0,
  unid_vent_acumulado NUMERIC(15,3) DEFAULT 0,

  -- Acumulado Ventas (Facturación €/$)
  acum_vent_enero NUMERIC(15,4) DEFAULT 0, acum_vent_febrero NUMERIC(15,4) DEFAULT 0,
  acum_vent_marzo NUMERIC(15,4) DEFAULT 0, acum_vent_abril NUMERIC(15,4) DEFAULT 0,
  acum_vent_mayo NUMERIC(15,4) DEFAULT 0, acum_vent_junio NUMERIC(15,4) DEFAULT 0,
  acum_vent_julio NUMERIC(15,4) DEFAULT 0, acum_vent_agosto NUMERIC(15,4) DEFAULT 0,
  acum_vent_septiembre NUMERIC(15,4) DEFAULT 0, acum_vent_octubre NUMERIC(15,4) DEFAULT 0,
  acum_vent_noviembre NUMERIC(15,4) DEFAULT 0, acum_vent_diciembre NUMERIC(15,4) DEFAULT 0,
  acum_vent_ejercicio NUMERIC(18,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS acum_clientes (
  ...
  acum_enero NUMERIC(15,4) DEFAULT 0,
  acum_febrero NUMERIC(15,4) DEFAULT 0,
  acum_marzo NUMERIC(15,4) DEFAULT 0,
  acum_abril NUMERIC(15,4) DEFAULT 0,
  acum_mayo NUMERIC(15,4) DEFAULT 0,
  acum_junio NUMERIC(15,4) DEFAULT 0,
  acum_julio NUMERIC(15,4) DEFAULT 0,
  acum_agosto NUMERIC(15,4) DEFAULT 0,
  acum_septiembre NUMERIC(15,4) DEFAULT 0,
  acum_octubre NUMERIC(15,4) DEFAULT 0,
  acum_noviembre NUMERIC(15,4) DEFAULT 0,
  acum_diciembre NUMERIC(15,4) DEFAULT 0,

  acum_ejercicio NUMERIC(18,4) DEFAULT 0, -- Total anual por cliente
...
CREATE TABLE IF NOT EXISTS acum_proveedores (
  ...
  acum_total NUMERIC(18,4) DEFAULT 0, -- Total anual de compras al proveedor
...
CREATE TABLE IF NOT EXISTS agentes (
  ...
  -- Financiero (NUMERIC para precisión en comisiones)
  facturado NUMERIC(15,4) DEFAULT 0,
  pendiente NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS agentes_comisiones (
  ...
  -- Tramos de importe (NUMERIC para precisión en moneda)
  importe_desde NUMERIC(15,4) DEFAULT 0,
  importe_hasta NUMERIC(15,4) DEFAULT 0,

  -- Porcentaje de comisión (ej: 5.50 para un 5.5%)
  porc_comision NUMERIC(5,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS articulos (
  id SERIAL PRIMARY KEY,
  codigo VARCHAR(200) DEFAULT NULL UNIQUE,
  ...
  coste NUMERIC(15,4) DEFAULT 0,
  coste_real NUMERIC(15,4) DEFAULT 0,
  pvp NUMERIC(15,4) DEFAULT 0,
  margen NUMERIC(15,4) DEFAULT 0,
  margen_min NUMERIC(15,4) DEFAULT 0,
  pvp_incluye_iva SMALLINT DEFAULT 0,

  -- Impuestos (IVA / TVA)
  id_tipos_iva INTEGER DEFAULT NULL,
  tipo_iva NUMERIC(5,2) DEFAULT 0,

  -- Descuentos
  porc_dto NUMERIC(5,2) DEFAULT 0,
  dto_proveedor NUMERIC(15,4) DEFAULT 0,

  -- Stock y Logística (NUMERIC para horas o servicios fraccionados)
  stock_real NUMERIC(12,3) DEFAULT 0,
  stock_fisico_almacen NUMERIC(12,3) DEFAULT 0,
  stock_maximo NUMERIC(12,3) DEFAULT 0,
  stock_minimo NUMERIC(12,3) DEFAULT 0,
  valor_stock NUMERIC(15,4) DEFAULT 0,
  unidades_reservadas NUMERIC(12,3) DEFAULT 0,
  cantidad_pendiente_recibir NUMERIC(12,3) DEFAULT 0,
  ...
  unidades_compradas NUMERIC(15,3) DEFAULT 0,
  unidades_vendidas NUMERIC(15,3) DEFAULT 0,
  importe_acumulado_compras NUMERIC(15,4) DEFAULT 0,
  importe_acumulado_ventas NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS articulos_volumen (
  ...
  -- Rangos de cantidad (NUMERIC para soportar horas o fracciones)
  desde NUMERIC(12,3) DEFAULT 0,
  hasta NUMERIC(12,3) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS avisos (
  ...
  aviso TEXT,
  fecha_hora_aviso TIMESTAMP DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS bancos (
  ...
  -- Estado Financiero
  saldo NUMERIC(15,2) DEFAULT 0.00, -- Ampliado para evitar desbordamiento en saldos altos
...
CREATE TABLE IF NOT EXISTS clientes (
  ...
  porc_dto_cliente NUMERIC(5,2) DEFAULT 0,
  ...
  -- Financiero (NUMERIC para precisión)
  acumulado_ventas NUMERIC(15,4) DEFAULT 0,
  ventas_ejercicio NUMERIC(15,4) DEFAULT 0,
  riesgo_maximo NUMERIC(15,4) DEFAULT 0,
  deuda_actual NUMERIC(15,4) DEFAULT 0,
  importe_a_cuenta NUMERIC(15,4) DEFAULT 0,
  importe_pendiente NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS clientes_deuda (
  ...
  -- Gestión de Importes (Precisión NUMERIC)
  importe NUMERIC(15,4) DEFAULT 0,
  pagado NUMERIC(15,4) DEFAULT 0,
  pendiente_cobro NUMERIC(15,4) DEFAULT 0,

  -- Desglose por Método de Pago (Útil para conciliación)
  importe_efectivo NUMERIC(15,4) DEFAULT 0,
  importe_tarjeta NUMERIC(15,4) DEFAULT 0,
  importe_cheque NUMERIC(15,4) DEFAULT 0,
  importe_transferencia NUMERIC(15,4) DEFAULT 0,
  importe_domiciliacion NUMERIC(15,4) DEFAULT 0,
  importe_internet NUMERIC(15,4) DEFAULT 0,
  importe_vale NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS clientes_entregas (
  ...
  importe NUMERIC(15,4) DEFAULT 0,     -- Lo que el cliente entregó originalmente
  disponible NUMERIC(15,4) DEFAULT 0,  -- El saldo que queda por consumir de ese pago
...
CREATE TABLE IF NOT EXISTS codigotarifa (
  ...
  descripcion VARCHAR(100) DEFAULT NULL UNIQUE, -- Ampliado para nombres más descriptivos
  ...
  margen NUMERIC(15,4) DEFAULT 0,     -- Margen de beneficio estándar para esta tarifa
  margen_min NUMERIC(15,4) DEFAULT 0, -- Margen mínimo (suelo) para evitar ventas en pérdida
...
CREATE TABLE IF NOT EXISTS deudas_proveedores (
  ...
  -- Gestión económica (NUMERIC para precisión)
  importe_deuda NUMERIC(15,4) DEFAULT 0,
  pagado NUMERIC(15,4) DEFAULT 0,
  pendiente NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS histo_clientes_deuda (
  ...
  importe_anterior NUMERIC(15,4) DEFAULT 0, -- Saldo antes del pago
  pagado NUMERIC(15,4) DEFAULT 0,           -- Cuánto se ha pagado en este movimiento
  importe_cambio NUMERIC(15,4) DEFAULT 0,   -- Por si hubo devolución de cambio
  pendiente_cobro NUMERIC(15,4) DEFAULT 0,  -- Saldo resultante tras el pago
...
CREATE TABLE IF NOT EXISTS kits (
  ...
  -- Cantidades y Costes (Precisión NUMERIC)
  cantidad NUMERIC(12,3) NOT NULL DEFAULT 0,
  coste_base NUMERIC(15,4) NOT NULL DEFAULT 0,
  porc_dto NUMERIC(5,2) DEFAULT 0,
  coste_final NUMERIC(15,4) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS monedas (
  ...
  nombre_corto VARCHAR(10) NOT NULL UNIQUE,    -- Ej: "EUR", "USD" (Código ISO)
  simbolo VARCHAR(5) DEFAULT NULL,      -- Ej: "€", "$"

  -- Lógica de Conversión
  cambio NUMERIC(15,6) DEFAULT 1.000000, -- Valor respecto a la moneda base
...
CREATE TABLE IF NOT EXISTS paises (
  id SERIAL PRIMARY KEY,
  pais VARCHAR(100) DEFAULT NULL UNIQUE,        -- Ej: "Francia", "España"
  country_code VARCHAR(5) NOT NULL UNIQUE,      -- ISO Alpha-2 (FR, ES, PT)
...
CREATE TABLE IF NOT EXISTS proveedor_entregas_a_cuenta (
  ...
  -- Control económico (NUMERIC para evitar errores de redondeo)
  importe NUMERIC(15,4) DEFAULT 0,    -- Dinero total entregado
  disponible NUMERIC(15,4) DEFAULT 0, -- Saldo que aún no ha sido aplicado a facturas
...
CREATE TABLE IF NOT EXISTS proveedores (
  ...
  dto NUMERIC(5,2) DEFAULT 0,
  deuda_maxima NUMERIC(15,4) DEFAULT 0,
  ...
  tipo_iva SMALLINT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS tarifas (
  ...
  -- Precios y Márgenes
  pvp NUMERIC(15,4) DEFAULT 0,            -- El precio final de venta
  margen NUMERIC(5,2) DEFAULT 0,         -- Porcentaje de beneficio aplicado
  margen_minimo NUMERIC(5,2) DEFAULT 0,  -- El límite para que el comercial no pierda dinero
...
CREATE TABLE IF NOT EXISTS tiposubcliente (
  ...
  descripcion TEXT DEFAULT NULL,        -- Para notas sobre este perfil de cliente
...
CREATE TABLE IF NOT EXISTS tiposiva (
  ...
  -- Valores numéricos (Precision NUMERIC)
  iva NUMERIC(5,2) DEFAULT 0.00,
  recargo_equivalencia NUMERIC(5,2) DEFAULT 0.00,
